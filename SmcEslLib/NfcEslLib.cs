...
namespace SmcEslLib
{
        ...
        public class SMCEslReceiveEventArgs: EventArgs
    {
        ...
        public void portOpen(string portName, string baurate)
        {
            try
            {
        ...
        public void eslImagePix(Bitmap bmp) {
                            string bit = "";
        string rbit = "";
        string totaldata = "";
        string totalreddata = "";
        ...
        public void eslImageLockBit(Bitmap bmp) {
        ...
        public void sendWriteBlackData(string data)
        {
        ...
        public void sendWriteBlackDataEnd()
        {
        ...
        public void sendWriteRedData4(string data)
        {
        ...
        public void sendWriteRedData8(string data)
        {
        ...
        public void sendWriteRedDataF(string data)
        {
        ...
        public void sendWriteRedDataEnd()
        {
